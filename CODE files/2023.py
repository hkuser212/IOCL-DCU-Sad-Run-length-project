...
# # plt.tight_layout()
# # #plt.show()
# # plt.savefig('correlation_matrix_2023.png')
#
...
# plt.axvspan(pd.to_datetime("10-04-2023"), pd.to_datetime("10-09-2023"), color='orange', alpha=0.3, label='SAD Period')
#
...
# #plt.show()
# plt.savefig('timeseries 2023_plot.png')
#
...
#     'COIL_dP_Pass1',
#     'COIL_dP_Pass3',
#     'Coil_Inlet_Pressure_Pass3',
#     'Coil_Inlet_Pressure_Pass1',
#     'Coil_Inlet_Pressure_Pass2',
#     'BFW_Injection_Pass4'
# ])
#
# y = df_cleaned[target]
...
sad_start = pd.to_datetime("2023-10-04")
sad_end = pd.to_datetime("2023-10-09")
...
import joblib
joblib.dump(model, 'sad_days_predictor_2023.pkl')
joblib.dump(X.columns.tolist(), 'sad_feature_columns_2023.pkl')