...
# df_raw = pd.read_csv('DCU - 2021.csv',header=4 , skiprows=[0, 1, 2, 3])
...
#
# sns.scatterplot(data=df_cleaned, x=top_feature, y='COIL_dP_Pass3')
# plt.title(f"{top_feature} vs COIL_dP_Pass3")
# plt.xlabel(top_feature)
# plt.ylabel("COIL_dP_Pass3")
# plt.grid(True)
# plt.show()
# plt.savefig('scatterplot2021.png')
# #
# #
# # sns.boxplot(data=df_cleaned, x=top_feature, y='COIL_dP_Pass3')
# # plt.title(f"{top_feature} vs COIL_dP_Pass3")
# # plt.xlabel(top_feature)
# # plt.ylabel("COIL_dP_Pass3")
# # plt.grid(True)
# # plt.show()
# # plt.savefig('boxplot2021.png')
# #
...
# plt.axvspan(pd.to_datetime("2021-05-03"), pd.to_datetime("2021-05-14"), color='orange', alpha=0.3, label='SAD Period')
#
...
# plt.show()
# plt.savefig('timeseries2021.png')
...
#     'COIL_dP_Pass1',
#     'COIL_dP_Pass2',
#     'COIL_dP_Pass3',  # target
#     'COIL_dP_Pass4',
#     # optionally remove COT_Pass1, COT_Pass3 if they strongly correlate
# ])
# y = df_model[target]
#
# # 🧪 Train-test split
...
sad_start = pd.to_datetime("2021-05-03")
sad_end = pd.to_datetime("2021-05-14")
...
import joblib
joblib.dump(model, 'sad_days_predictor_2021.pkl')
joblib.dump(X.columns.tolist(), 'sad_feature_columns_2021.pkl')
